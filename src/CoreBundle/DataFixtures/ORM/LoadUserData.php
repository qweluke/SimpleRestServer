    ...
    public function userList()
    {
        $list = [
            ['username' => 'root', 'roles' => ['ROLE_ADMIN', 'ROLE_API'], 'password' => 'root', 'enabled' => true,
                'firstName' => 'James T.', 'lastName' => 'Kirk', 'gender' => 'male'],
            ['username' => 'user1', 'roles' => ['ROLE_USER', 'ROLE_API'], 'password' => 'user1', 'enabled' => true,
                'firstName' => 'Deanna', 'lastName' => 'Troi', 'gender' => 'female'],
            ['username' => 'user2', 'roles' => ['ROLE_USER', 'ROLE_API'], 'password' => 'user2', 'enabled' => true,
                'firstName' => 'Nyota', 'lastName' => 'Uhura', 'gender' => 'female'],
            ['username' => 'user3', 'roles' => ['ROLE_USER', 'ROLE_API'], 'password' => 'user3', 'enabled' => true,
                'firstName' => 'Hikrau', 'lastName' => 'Sulu', 'gender' => 'male'],
            ['username' => 'user4', 'roles' => ['ROLE_USER', 'ROLE_API'], 'password' => 'user4', 'enabled' => false,
                'firstName' => 'Montgomery', 'lastName' => 'Scott', 'gender' => 'male'],
        ];
